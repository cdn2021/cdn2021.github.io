//Check the compatible
{
	...
	console.log("%c\n       ", "font-size:41px;background:url('https://pig-cmd.github.io/eso1242a/eso1242a-screen.jpg') no-repeat -135px -1px");
	console.log("%c\n       ", "font-size:41px;background:url('https://cdn2021.github.io/GE/img/earth.bmp') no-repeat -135px -1px");
